Shader "DianDian/PBR"
{
	Properties
	{
		...
		[Toggle]_Use_Dissolve("Use Dissolve",float) = 0
		_NoiseTex("NoiseTex",2D) = "white" {}
        _Off("Off",Range(-3,3)) = 1
        _OffInt("Off Int",Range(0,30)) = 1

		[Toggle]_Outline("Use Outline",float) = 0
	...
	SubShader
	{
		...
		UsePass "Hidden/Utilities/Outline/Outline"
	}
