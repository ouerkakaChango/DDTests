...
half3 SpecularTerm_BRDF2_Anisotropic_Cloth(half3 lightColor, half3 specColor, half nl, half3 worldNormal, half3 lightDir, half3 viewDir, half smoothness, half roughness, half3 worldTangent)
{
	...
	half3 DD_Common_LightingFunc_Direct_Cloth(in ShadingData_T shadingData, in LightingInput lightingInput, in DDLight light)
{
	...
	half3 specTerm1 = SpecularTerm_BRDF2_Anisotropic_Cloth(lightColor, specular, nl, lightingInput.worldNormal, L, lightingInput.viewDir, smoothness, roughness, lightingInput.worldTangent);
