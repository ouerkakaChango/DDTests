Shader "CGBull/CharacterRender/SeparableSubsurfaceScatter/Surface/Standard_Skin" {
    ...
    SubShader {
        Pass {
			...
			#pragma multi_compile UNITY_HARDWARE_TIER1 UNITY_HARDWARE_TIER2 UNITY_HARDWARE_TIER3
...
/// Final Color:
                ...
                half4 finalRGBA = half4(finalColor, -1.0f);
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                half4 finalRGBA = half4(finalColor * 1, -1);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
